...
public class ErrorHandler {
    ...
    public ErrorHandler(FragmentManager fm,
    ...
    public void handleError(ErrorCommand errorCommand, Runnable defaultAction) {
            ...
            try {
                ...
                if (context != null) {
                    Toast.makeText(context,
                            "can not start request activity: " + e.getMessage(),
                            Toast.LENGTH_LONG)
                            .show();
                }
            }
    ...
    public static class EditRequestFragment extends Fragment {
        ...
        public void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
            switch (requestCode) {
                case ErrorHandler.EDIT_REQUEST_CODE: {
