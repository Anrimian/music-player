package com.github.anrimian.musicplayer.ui.utils.views.recycler_view.decorators;
...
public class DividerItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public DividerItemDecoration(Context context,
                                 int orientation,
                                 int dividerMarginStart,
                                 boolean drawLastDivider) {
    ...
    private void drawVertical(Canvas canvas, RecyclerView parent, RecyclerView.State state) {
        ...
        left += dividerMarginStart;
        final int childCount = parent.getChildCount();
        for (int i = 0; i < childCount; i++) {
            final View child = parent.getChildAt(i);
            if (!drawLastDivider &&
                    parent.getChildAdapterPosition(child) == state.getItemCount() - 1) {
                continue;
            }
